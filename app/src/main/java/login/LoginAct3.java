 ...
 */
public class LoginAct3 extends AppCompatActivity {
    ...
    private static final String TAG = LoginAct3.class.getSimpleName();
        ...
        *********************************************/
        ...
        mFacebookAccessTokenTracker = new AccessTokenTracker() {
            ...
            protected void onCurrentAccessTokenChanged(AccessToken oldAccessToken, AccessToken currentAccessToken) {
                Log.i(TAG, "Facebook.AccessTokenTracker.OnCurrentAccessToeknChanged");
                LoginAct3.this.onFacebookAccessTokenChange(currentAccessToken);
            }
        };
...
//                String resp = response.body().string();
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                Intent i = new Intent(context, main.MainAct.class);
