...
import com.amazonaws.mobilehelper.auth.signin.ui.buttons.FacebookButton;
...
public class SignInView extends LinearLayout {
    ...
    public SignInView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        final int signInButtonWidth = getResources().getDimensionPixelSize(R.dimen.sign_in_button_width);
        final int signInButtonHeight = getResources().getDimensionPixelSize(R.dimen.sign_in_button_height);

        facebookButton = new FacebookButton(context);
        final LinearLayout.LayoutParams facebookButtonLayoutParams
            = new LinearLayout.LayoutParams(signInButtonWidth, signInButtonHeight);
        facebookButtonLayoutParams.setMargins(0, signInButtonMargin, 0, signInButtonMargin);
        addView(facebookButton, facebookButtonLayoutParams);
    ...
    private void resizeImageView() {
        ...
        if (facebookButton.getMeasuredHeight() > 0) {
            availableHeight -= facebookButton.getMeasuredHeight();
