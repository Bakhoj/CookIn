...
public class IdentityManager {
     ...
     * any com.cookin.login providers.
     */
    private class SignInProviderResultAdapter implements SignInProviderResultHandler {
        ...
        public void onSuccess(final IdentityProvider provider) {
            ...
            // Update Cognito com.cookin.login with the token.
    ...
    private void refreshCredentialWithLogins(final Map<String, String> loginMap) {
        ...
        final String sharedPrefName = "com.com.amazonaws.android.auth";
     ...
     * @param onReloadComplete Runnable to be executed on the com.cookin.main thread after user info
