...
public interface IdentityProfile {
    ...
    /**
     * Get Additional User Profile com.cookin.data.
     *
     * @return a Map containing additional user profile com.cookin.data.
     */
    Map<String, String> getCustomProfileAttributesMap();

    /**
     * Load the profile information using the corresponding identity provider.
     * This method will make a network call and must not be called on the com.cookin.main thread.
     ...
     * This method will block and must not be called on the com.cookin.main thread.
     */
