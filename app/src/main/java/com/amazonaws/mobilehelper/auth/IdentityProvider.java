...
public interface IdentityProvider {
    ...
    /**
     * @return the key used by Cognito in its com.cookin.login map when refreshing credentials.
     */
    String getCognitoLoginKey();

    /**
     * Refreshes the state of whether the user is signed-in and returns the updated state.
     * Note: This call may block, so it must not be called from the com.cookin.main thread.
