package com.amazonaws.mobile.signin;
//
...
public class FacebookSignInProvider implements SignInProvider {
    ...
    /** The Cognito com.cookin.login key for Facebook to be used in the Cognito com.cookin.login Map. */
     ...
     * the facebook backend to allow com.cookin.login from the app.
     *
    ...
    public View.OnClickListener initializeSignInButton(final Activity signInActivity,
        ...
        if (buttonView == null) {
            throw new IllegalArgumentException("Facebook com.cookin.login button view not passed in.");
        }
